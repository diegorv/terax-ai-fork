...
pub async fn workspace_current_dir(
    ...
    // The process cwd is useless as a default workspace: it's "/" when
    // launched from Finder/Dock and "<repo>/src-tauri" under `tauri dev`.
    // Mirror Terminal.app / iTerm2 and default to $HOME.
